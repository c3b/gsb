...
class PdoGsb{   		
    ...
    */	
    ...
    public function dernierMoisCloture($idVisiteur){
        ...
        $res = PdoGsb::$monPdo->query($req);
        $laLigne = $res->fetch();
        $dernierMoisCloture = $laLigne['dernierMois'];
        return $dernierMoisCloture;
    }
    ...
    */
    ...
    /**
     * Refuse un frais hors forfait en ajoutant REFUSE dans le descriptif de frais
     * 
     * @param $idFrais
     */
     ...
     * @param $idFrais
     */
    public function refuserFraisHorsForfaitTronque($idFrais){
        $req = "UPDATE lignefraishorsforfait SET libelle = CONCAT ('REFUSE' , ' ', SUBSTRING(libelle,6) ) WHERE lignefraishorsforfait.id =$idFrais ";
        PdoGsb::$monPdo->exec($req);
    }
    ...
    */	
    ...
    public function getLesFichesFraisSuivi($mois){
        $req = "select fichefrais.idEtat as idEtat, visiteur.nom as nom, visiteur.prenom as prenom, fichefrais.mois as leMois, fichefrais.idVisiteur as idVisiteur, fichefrais.dateModif as dateModif, fichefrais.nbJustificatifs as nbJustificatifs, 
                ...
                where fichefrais.mois = '$mois' and (idEtat ='VA' or idEtat = 'RB') order by dateModif desc";
        $res = PdoGsb::$monPdo->query($req);
